...
The file `images.zip` contains all figures that appear in the paper and appendix (generated by the scripts above). Unzip to inspect them without re-running experiments:

```bash
unzip images.zip -d figures
```
